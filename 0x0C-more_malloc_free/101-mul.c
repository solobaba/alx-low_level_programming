 ...
 *
 * Descritption: If there is insuffixient space, the function
 ...
 *
 * Description: If c is a non-digit, the funtion exits
 * with a status 98.
 *
...
/**
 * get_prod - Multiplies a sting of numbers by a single digit.
...
/**
 * add_nums - Adds the numbers sotred in two strings.
 ...
 * @arcg: An array of pointers to the argument.
 *
